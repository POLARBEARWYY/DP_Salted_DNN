...
def get_parser():
    ...
    #parser.add_argument('--salt_layer', type=int, default=-1, help='salt layer setting (default: -1)')
    #parser.add_argument('--num_input_channels', type=int, default=3, help='number of input channels (default: 3)')
